...
# Database: SQLite by default; override with DATABASE_URL (e.g., Postgres) in prod.
DATABASES = {
    "default": {
...
# Use manifest storage only when DEBUG is False (prevents 500s if collectstatic not run locally)
if DEBUG:
    STORAGES = {
        "staticfiles": {
